...
-- Optional public profile fields (ensure columns exist)
ALTER TABLE IF NOT EXISTS users ADD COLUMN IF NOT EXISTS forehand_rubber TEXT;
ALTER TABLE IF NOT EXISTS users ADD COLUMN IF NOT EXISTS backhand_rubber TEXT;
ALTER TABLE IF NOT EXISTS users ADD COLUMN IF NOT EXISTS blade_wood TEXT;
ALTER TABLE IF NOT EXISTS users ADD COLUMN IF NOT EXISTS playstyle VARCHAR(100);
ALTER TABLE IF NOT EXISTS users ADD COLUMN IF NOT EXISTS strengths TEXT;
ALTER TABLE IF NOT EXISTS users ADD COLUMN IF NOT EXISTS weaknesses TEXT;
ALTER TABLE IF NOT EXISTS users ADD COLUMN IF NOT EXISTS goals TEXT;
