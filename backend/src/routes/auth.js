...
const { validateHoneypot } = require('../middleware/captcha');
 ...
 */
router.post('/register', validateHoneypot, validateRegistration, async (req, res) => {
    try {
 ...
 * POST /api/auth/login
 */
router.post('/login', validateHoneypot, validateLogin, async (req, res) => {
    try {
