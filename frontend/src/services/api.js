...
export const leaguesAPI = {
  ...
  requestJoin: (id) => api.post(`/leagues/${id}/join-requests`),
  getJoinRequests: (id, params, options) => cachedGet(`/leagues/${id}/join-requests`, { params }, options),
  approveJoinRequest: (id, requestId) => api.post(`/leagues/${id}/join-requests/${requestId}/approve`),
  declineJoinRequest: (id, requestId) => api.post(`/leagues/${id}/join-requests/${requestId}/decline`),
